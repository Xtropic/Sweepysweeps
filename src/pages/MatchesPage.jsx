    ...
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div style={{ minWidth: 0 }}>
          <h1 style={{ fontSize: 18, color: '#0D1B2A', marginBottom: 2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Sweepy Sweep Sweep Stakes</h1>
          <p style={{ fontSize: 12, color: 'rgba(13,27,42,0.5)' }}>World Cup 2026 Predictions</p>
        </div>
      </div>
